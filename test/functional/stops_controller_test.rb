...
class StopsControllerTest < ActionController::TestCase
  ...
  test "should create stop" do
    assert_difference('Stop.count') do
      post :create, stop: { stop_id: @stop.stop_id, stop_lat: @stop.stop_lat, stop_lon: @stop.stop_lon, stop_name: @stop.stop_name }
    end
  ...
  test "should update stop" do
    put :update, id: @stop, stop: { stop_id: @stop.stop_id, stop_lat: @stop.stop_lat, stop_lon: @stop.stop_lon, stop_name: @stop.stop_name }
    assert_redirected_to stop_path(assigns(:stop))
  end
