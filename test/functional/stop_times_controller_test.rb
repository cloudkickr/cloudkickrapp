...
class StopTimesControllerTest < ActionController::TestCase
  ...
  test "should create stop_time" do
    assert_difference('StopTime.count') do
      post :create, stop_time: { arrival_time: @stop_time.arrival_time, departure_time: @stop_time.departure_time, stop_id: @stop_time.stop_id, stop_sequence: @stop_time.stop_sequence, trip_id: @stop_time.trip_id }
    end
  ...
  test "should update stop_time" do
    put :update, id: @stop_time, stop_time: { arrival_time: @stop_time.arrival_time, departure_time: @stop_time.departure_time, stop_id: @stop_time.stop_id, stop_sequence: @stop_time.stop_sequence, trip_id: @stop_time.trip_id }
    assert_redirected_to stop_time_path(assigns(:stop_time))
  end
